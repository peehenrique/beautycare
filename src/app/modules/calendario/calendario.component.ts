...
export class CalendarioComponent implements OnInit {
  ...
  public changeMounth(n:number):void{
    let atual = new Date(new Date().setDate(1));
    let novadata = new Date(new Date(this.dt.setMonth(this.dt.getMonth()+(n))).setDate(1));
  ...
  public toggleEvento(evento:any):void{
    evento.show=(evento.show)?false:true;
  }
